...
@DisplayName("Test Validasi Util")
public class ValidationUtilsTest {
    ...
    void testNomorTeleponValid() {
        assertTrue(ValidationUtils.isValidNomorTelepon("08123456789"));       // format dasar
        assertTrue(ValidationUtils.isValidNomorTelepon("+628123456789"));    // format internasional
        assertTrue(ValidationUtils.isValidNomorTelepon("+6281234567890"));   // internasional panjang
        assertTrue(ValidationUtils.isValidNomorTelepon("0812-3456-7890"));   // dengan strip
    }

    @ParameterizedTest
    @ValueSource(strings = {"", " ", "123456789", "071234567890", "081234"})
    ...
    void testBukuTidakValid() {
        ...
        // ISBN tidak valid
        Buku bukuIsbnTidakValid = new Buku("123", "Judul", "Pengarang", 0, 100000.0);
    ...
    // ==================== STRING ====================
    @Test
    @DisplayName("String valid dan tidak valid harus diuji")
    ...
    void testValidasiAngka() {
        ...
        assertTrue(ValidationUtils.isAngkaPositif(1000));
