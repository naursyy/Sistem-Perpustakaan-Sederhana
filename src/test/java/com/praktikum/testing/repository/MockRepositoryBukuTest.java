 ...
 * - Memahami dan behavior mock manual dengan real implementation
 */
...
class MockRepositoryBukuTest {
    ...
    void testCariBytIsbnBukuDitemukan() {
        // Arrange
        mockRepository.simpan(buku1);
    ...
    void testCariBytIsbnBukuTidakDitemukan() {
        // Arrange
        mockRepository.simpan(buku1);
    ...
    void testUpdateJumlahTersediaValid() {
        ...
        assertEquals(3, bukuUpdated.get().getJumlahTersedia(), "Jumlah tersedia harus tetap sama");
    ...
    void testUpdateJumlahTersediaBukuTidakDitemukan() {
        // Act
        boolean hasil = mockRepository.updateJumlahTersedia("9999999999", 3);
