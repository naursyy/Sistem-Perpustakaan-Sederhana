...
public class KalkulatorDendaTest {
    ...
    void setUp() {
        ...
        anggotaMahasiswa = new Anggota("M001", "John Student", "john@student.ac.id", "08123456789", Anggota.TipeAnggota.MAHASISWA);
        anggotaDosen = new Anggota("D001", "Dr. Teacher", "teacher@ac.id", "08123456789", Anggota.TipeAnggota.DOSEN);
        anggotaUmum = new Anggota("U001", "Public User", "public@email.com", "08123456789", Anggota.TipeAnggota.UMUM);
    }
    ...
    void testDeskripsiDenda() {
        ...
        assertEquals("Denda berat", kalkulatorDenda.getDeskripsiDenda(50000.0));
    }
}